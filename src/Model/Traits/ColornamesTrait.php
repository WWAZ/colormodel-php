...
trait ColornamesTrait
{
    ...
    {
        if($this->getColorName()) return true;
        return false;
    }

    public function getColorName()
    {
        $names = array_flip(self::$HTMLColorNames);

        $hex = $this->toHex()->toString();
    ...
    public function getColorFromName($name)
    {   
        $name = strtolower($name);
        $names = self::$HTMLColorNames;
        if( isset($names[$name]) ){
            return new Hex($names[$name]);
        }
        return null;
    }
     ...
     * @var array
     */
    protected static $HTMLColorNames = [
        'black'                => 0x000000,
        'darkgreen'            => 0x006400,
        'green'                => 0x008000,
        'maroon'               => 0x800000,
